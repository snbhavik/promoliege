...
(function() {
    var provider = app.data.promosLiegeBackend = new Everlive({
            offlineStorage: true,
        	offline: true,
            apiKey: telerikKey,
    ...
    document.addEventListener('online', function() {
        app.data.promosLiegeBackend.offline(false);
        app.data.promosLiegeBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.promosLiegeBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_promosLiegeBackend
// END_CUSTOM_CODE_promosLiegeBackend